...
/* Generated from ../O.Common/YAG.dbd */
...
int YAG_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/pi/Apps/epics/IOCs/YAG";
...
/* YAG_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"YAG_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    YAG_registerRecordDeviceDriver(*iocshPpdbbase);
}
