...
/* Generated from ../O.Common/lasersIOC.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynFloat64TimeSeries", "devXxxSoft"
};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_initTraceRegister, pvar_func_streamRegistrar,
    pvar_func_syncInitialize, pvar_func_tsInitialize,
    pvar_func_vxi11RegisterCommands, pvar_func_register_func_myAsubInit,
...
int lasersIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/pi/Apps/epics/IOCs/lasers";
...
/* lasersIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"lasersIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    lasersIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
